...
description: Aquest article proporciona informació sobre les actualitzacions de qualitat que estan disponibles a la versió d'octubre de 2021 d'Operacions de projectes per a escenaris emmagatzemats / basats en la producció.
author: andchoi
ms.date: 11/17/2021
ms.topic: article
ms.prod: ''
...
| Administració i comptabilitat de projectes | [577857](https://fix.lcs.dynamics.com/Issue/Details/?bugId=577857) | Els valors de dèbit i crèdit es canvien quan s'utilitza el Microsoft Excel complement amb el diari de despeses del projecte i el **camp Tipus de** compte offset està definit com a **Projecte**. |
...
| Administració i comptabilitat de projectes | [598706](https://fix.lcs.dynamics.com/Issue/Details/?bugId=598706) | L'aplicació Project Timesheet Mobile per Android deixar de respondre. El problema està relacionat amb **TimeEntryDataManager ArgumentNullException**. |

...
| Administració i comptabilitat de projectes | [577598](https://fix.lcs.dynamics.com/Issue/Details/?bugId=577598) | El preu de venda del projecte en una comanda de compra del projecte facturat es calcula incorrectament quan el model de preu de venda és **la relació de contribució**. |
...
| Administració i comptabilitat de projectes | [598109](https://fix.lcs.dynamics.com/Issue/Details/?bugId=598109) | Després d'aplicar kb 461935, no podeu publicar estimacions si canvieu a seqüències de nombres contínues. |
| Administració i comptabilitat de projectes | [598688](https://fix.lcs.dynamics.com/Issue/Details/?bugId=598688) | **TimeEntryDataManager** fa que l'aplicació Android mòbil del full de temps del projecte deixi de respondre. |

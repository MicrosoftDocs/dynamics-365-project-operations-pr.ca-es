...
description: En aquest article s'ofereix informació sobre el tipus d'implementació, Operacions de projecte per a escenaris emmagatzemats/basats en la producció.
author: rumant
ms.date: 11/02/2020
ms.topic: overview
...
- Gestió de vendes basades en projectes mitjançant el **mòdul Vendes i màrqueting** en aplicacions Dynamics 365 Finance and Operations
- Preus del projecte i costos mitjançant la configuració de la taxa de cost i la taxa de factura a les aplicacions de finances i operacions
- Gestió de recursos per a projectes en aplicacions de Finances i Operacions
- Progrés del projecte i seguiment del temps a les aplicacions de finances i operacions
...
Aquest tipus d'implementació també proporciona una extensió de la funcionalitat proporcionada per les Dynamics 365 Finance i Dynamics 365 Supply Chain Management aplicacions.
...
- L'organització ja té aplicacions de cadena de subministrament i fabricació Dynamics 365 Finance o Dynamics 365 i la integració de transaccions basades en projectes simplificarà l'accés a les dades i les necessitats d'informes.

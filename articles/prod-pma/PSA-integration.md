...
description: Aquest article proporciona informació sobre la solució d'integració del Dynamics 365 Project Service Automation amb el Dynamics 365 Finance.
author: ruhercul
ms.date: 07/25/2019
ms.topic: overview
ms.prod: ''

...
description: Pots configurar les polítiques de despeses que han de seguir els teus treballadors a l'hora d'introduir i presentar informes de despeses i sol·licituds de viatge al Microsoft Dynamics 365 Finance.
author: suvaidya
ms.date: 05/20/2020
ms.topic: article
ms.prod: ''

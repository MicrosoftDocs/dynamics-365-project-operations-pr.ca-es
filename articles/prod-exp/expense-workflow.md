...
description: En aquest article s'explica com podeu utilitzar el sistema de flux de treball al Microsoft Dynamics 365 Finance per configurar un procés de revisió dels informes de despeses a Gestió de despeses.

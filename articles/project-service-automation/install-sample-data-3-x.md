...
- **\<EntitiesToEnableScheduling\>** especifica quines entitats s'han d'habilitar per a la Reserva a la Planificació del Microsoft Dynamics (àlies Universal Resource Scheduling).

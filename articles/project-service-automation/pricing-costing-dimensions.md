...
A causa d'això, hi ha dos tipus de valors de dimensió de preus disponibles al Project Service Automation (PSA): 
...
- [Configurar camps personalitzats com a dimensions de preus](set-up-pricing-dimensions.md)

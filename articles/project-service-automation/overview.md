...
Esteu buscant recursos per ajudar a planificar la vostra implementació? Consulteu aquests guies descarregables.
 ...
 [Planificació de projectes i guia de seguiment](../project-service/implementation-guides/project-planning-tracking.md)

 [Guia bàsica d'ofertes, preus i facturació](../project-service/implementation-guides/begin-quoting-pricing-billing.md)

 [Guia avançada d'ofertes, preus i facturació](../project-service/implementation-guides/adv-quoting-pricing-billing.md)

 [Guia d'administració de recursos](../project-service/implementation-guides/resource-management-guide.md)

 [Guia d'informes](../project-service/implementation-guides/reporting-guide.md)

 [Notes per a desenvolupadors](../project-service/developer-guides/overview-dev-notes-v3.x.md)
...
## <a name="guidance-for-earlier-versions-app-version-2x-or-1x"></a>Guia per a les versions anteriors (2.x o 1.x)
 ...
 [Guia de l'administrador de projectes](../project-service/project-manager-guide.md)

 [Guia de l'administrador de comptes](../project-service/account-manager-guide.md)

 [Hores, despeses i col·laboració](../project-service/time-expense-collaboration-guide.md)

 [Notes del producte (versió 2.x o 1.x)](../project-service/white-papers.md)

 [Notes per a desenvolupadors (versió 2.x de l'aplicació)](../project-service/developer-guides/add-custom-qoi-forms-v2.x.md)

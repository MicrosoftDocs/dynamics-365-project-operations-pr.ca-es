...
## <a name="upload-a-project-file-to-sharepoint-or-office-groups"></a>Carregar un fitxer del Project al SharePoint o als grups de l'Office  
 Podeu carregar el fitxer del Project al SharePoint i trobar-lo als documents associats del projecte del [!INCLUDE[pn_project_service_auto](../includes/pn-project-service-auto.md)].  Heu de demanar a l'administrador que configuri l'administració de documents del SharePoint i l'activi per a l'entitat del Project. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Configurar la integració del SharePoint](../admin/set-up-sharepoint-integration.md)  

 També podeu carregar el fitxer del Project al [!INCLUDE[pn_onedrive_for_business](../includes/pn-onedrive-for-business.md)] si heu configurat els Grups de l'Office. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Col·laborar amb els vostres companys de feina mitjançant grups de l'Office 365](../basics/collaborate-with-colleagues-using-office-365-groups.md)  

...
## <a name="using-journals-to-record-costs"></a>Utilitzar llibres diari per registrar costos de registre

Al PSA, els llibres diari permeten registrar costos o ingressos en classes de material, quota, temps, despeses o transaccions tributàries. Un llibre diari té una capçalera, línies i una acció **Confirmació**. Aquests són alguns escenaris en què podeu utilitzar un llibre diari:

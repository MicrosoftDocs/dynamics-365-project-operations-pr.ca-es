...
| Actualitza el lliurament | Fase 1 (gener 2022) | Fase 2 (onada d'abril de 2022) | Fase 3  |
|------------------|------------------------|---------------------------|---------------------------|
...
| El WBS es validarà contra els límits coneguts del client d'escriptori Project. | |  | :heavy_check_mark: |
...
- L'entorn de destinació s'ha d'actualitzar al project Service Automation Update Release 41 (3.10.62.162) o posterior.
...
### <a name="initiate-upgrade"></a>Inicia l'actualització 

1. Power Platform Al centre d'administració, cerqueu i seleccioneu el vostre entorn. A continuació, a les aplicacions, cerqueu i seleccioneu **Dynamics 365 Project Operations**.
...
### <a name="validate-common-scenarios"></a>Valida els escenaris comuns

Quan valideu les personalitzacions específiques, us recomanem que reviseu també els processos de negoci compatibles amb totes les aplicacions. Aquests processos de negoci inclouen, però no es limiten a, la creació d'entitats de vendes, com ara pressupostos i contractes, i la creació de projectes que incloguin WBSs i aprovació de reals.

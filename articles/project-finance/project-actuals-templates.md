...
Aquest tema descriu les plantilles i tasques subjacents que s'utilitzen per sincronitzar els valors reals del projecte directament des del Dynamics 365 Project Service Automation al Dynamics 365 Finance.
...
[![Flux de dades per a la integració de Project Service Automation amb el Finance and Operations](./media/ProjectActualsFlow.jpg)](./media/ProjectActualsFlow.jpg)
...
- Si esteu creant una plantilla nova, heu d'afegir la columna per admetre les despeses i els temps entre empreses. Seleccioneu **Afegeix una columna condicional** i introduïu un nom per a la columna, com ara **LegalEntity**. Introduïu una condició per a la columna, on, if **msdyn\_contractorganizationalunitid.msdyn\_name** is \<unitat organitzativa\>, then \<introduïu l'entitat jurídica\>; else null.
...
[![Assignació de plantilla](./media/ActualsMapping.jpg)](./media/ActualsMapping.jpg)

[![Assignació de plantilla](./media/TransactionConnections.jpg)](./media/TransactionConnections.jpg)
...
A la plantilla d'actualització de valors reals del projecte, heu d'utilitzar el Microsoft Power Query per completar aquestes tasques:
...
[![Assignació de plantilla](./media/ActualsUpdateMapping.jpg)](./media/ActualsUpdateMapping.jpg)

[![Assignació de plantilla](./media/TransactionConnectionsUpdate.jpg)](./media/TransactionConnectionsUpdate.jpg)

...
Per crear els detalls de la línia d'oferta, seleccioneu **+ Nou detall de la línia d'oferta** a la subquadrícula **Detalls de la línia d'oferta**. S'obrirà un control lliscant de creació ràpida. Els camps següents del formulari **Línia d'oferta**:

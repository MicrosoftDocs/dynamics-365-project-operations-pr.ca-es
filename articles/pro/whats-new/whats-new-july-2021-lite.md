...
description: Aquest article proporciona informació sobre les actualitzacions de qualitat disponibles a la versió de juliol de 2021 de la implementació del lite d'operacions del projecte.
author: sigitac
ms.date: 07/07/2021
ms.topic: article
ms.prod: ''

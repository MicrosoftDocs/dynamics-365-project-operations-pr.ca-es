...
### <a name="create-new-invoice-line-details"></a>Creació dels detalls de la nova línia de factura

A les línies de factura de temps i material, podeu crear detalls de línia de factura nous. Aquests detalls de la línia de factura no es basen en un valor real. A la línia de factura d'una línia de factura de temps i material, podeu seleccionar **Nou** per crear un nou detall de línia de factura per a les classes de transaccions que s'inclouen a la línia de contracte.
...
## <a name="product-based-invoice-lines"></a>Línies de factura basades en el projecte
